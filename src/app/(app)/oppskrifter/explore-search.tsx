...
import { searchSpoonacular, importSpoonacularRecipe } from "./search/actions";
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground">
        Søk blant 685 000+ internasjonale oppskrifter. Importer de du liker til dine oppskrifter.
      </p>
          ...
          return (
            <Card key={recipe.id} className="overflow-hidden p-0">
              ...
              <div className="p-3 space-y-2">
                ...
                <div className="flex gap-2">
                  <Link href={`/oppskrifter/search/${recipe.id}`} className="flex-1">
      ...
      {!hasSearched && (
        <div className="text-center py-8 text-muted-foreground">
          ...
          <p>Skriv et søkeord for å finne oppskrifter</p>
        </div>
      )}
