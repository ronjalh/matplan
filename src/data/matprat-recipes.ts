...
export const matpratRecipes: MatpratRecipe[] = [
  ...
  // === EKSTRA BARNEVENNLIGE (15 oppskrifter) ===
  {
    id: -61,
    name: "Pølser i lompe med ketchup",
    isFishMeal: false,
    isVegetarian: false,
    isVegan: false,
    cuisine: "Norsk",
    ...
    ingredients: [
      ...
      { name: "ketchup", quantity: 3, unit: "ss" },
      { name: "sennep", quantity: 2, unit: "ss" },
      { name: "stekt løk", quantity: 3, unit: "ss" },
    ],
    instructions:
      "1. Kok eller grill pølsene i 5–6 minutter.\n2. Varm lompene i en tørr stekepanne i ca. 30 sekunder på hver side.\n3. Legg en pølse på hver lompe.\n4. Topp med ketchup, sennep og stekt løk etter ønske.\n5. Rull sammen og server.",
    isKidFriendly: true,
  },
  {
    id: -62,
    name: "Fiskekaker i hvit saus med gulrøtter",
    isFishMeal: true,
    isVegetarian: false,
    isVegan: false,
    cuisine: "Norsk",
    prepTimeMinutes: 25,
    ingredients: [
      { name: "fiskekaker", quantity: 8, unit: "stk" },
      { name: "smør", quantity: 2, unit: "ss" },
      { name: "hvetemel", quantity: 2, unit: "ss" },
      { name: "melk", quantity: 4, unit: "dl" },
      { name: "gulrot", quantity: 4, unit: "stk" },
      { name: "poteter", quantity: 6, unit: "stk" },
      { name: "salt", quantity: 0.5, unit: "ts" },
      { name: "pepper", quantity: 0.25, unit: "ts" },
    ],
    instructions:
      "1. Skrell og kok potetene i lettsaltet vann i ca. 20 minutter.\n2. Skrell gulrøttene og kok dem hele i 10–15 minutter.\n3. Stek fiskekakene i smør på middels varme i 3–4 minutter på hver side.\n4. Lag hvit saus: Smelt smør, rør inn mel, tilsett melk litt etter litt under omrøring. Kok til den tykner.\n5. Smak til med salt og pepper.\n6. Server fiskekakene med poteter, gulrøtter og hvit saus.",
    isKidFriendly: true,
  },
  {
    id: -63,
    name: "Grøt med sukker og kanel",
    isFishMeal: false,
    isVegetarian: true,
    isVegan: false,
    cuisine: "Norsk",
    prepTimeMinutes: 20,
    ingredients: [
      { name: "melk", quantity: 8, unit: "dl" },
      { name: "semulegryn", quantity: 1.5, unit: "dl" },
      { name: "sukker", quantity: 2, unit: "ss" },
      { name: "kanel", quantity: 1, unit: "ts" },
      { name: "smør", quantity: 1, unit: "ss" },
      { name: "salt", quantity: 0.25, unit: "ts" },
    ],
    instructions:
      "1. Kok opp melken i en gryte.\n2. Dryss i semulegrynet under omrøring.\n3. Kok på svak varme i 5–7 minutter under omrøring til grøten tykner.\n4. Tilsett en klype salt.\n5. Server i boller med smørøye, sukker og kanel.",
    isKidFriendly: true,
  },
  {
    id: -64,
    name: "Makaroni med pølsebiter og ketchup",
    isFishMeal: false,
    isVegetarian: false,
    isVegan: false,
    cuisine: "Norsk",
    prepTimeMinutes: 15,
    ingredients: [
      { name: "makaroni", quantity: 400, unit: "g" },
      { name: "grillpølser", quantity: 4, unit: "stk" },
      { name: "ketchup", quantity: 4, unit: "ss" },
      { name: "smør", quantity: 1, unit: "ss" },
      { name: "ost", quantity: 100, unit: "g" },
    ],
    instructions:
      "1. Kok makaronien etter anvisning på pakken.\n2. Skjær pølsene i skiver og stek dem i smør til de er gylne.\n3. Bland den kokte makaronien med pølsebitene.\n4. Rør inn ketchup og server med revet ost på toppen.",
    isKidFriendly: true,
  },
  {
    id: -65,
    name: "Ostesmørbrød i ovn",
    isFishMeal: false,
    isVegetarian: true,
    isVegan: false,
    cuisine: "Norsk",
    prepTimeMinutes: 15,
    ingredients: [
      { name: "loff", quantity: 8, unit: "skiver" },
      { name: "ost", quantity: 200, unit: "g" },
      { name: "smør", quantity: 2, unit: "ss" },
      { name: "skinke", quantity: 8, unit: "skiver" },
      { name: "tomat", quantity: 2, unit: "stk" },
    ],
    instructions:
      "1. Sett ovnen på 225°C.\n2. Smør brødskivene med smør og legg dem på et stekebrett.\n3. Legg på skinke og tomatskiver.\n4. Strø rikelig med revet ost på toppen.\n5. Stek i ovnen i 8–10 minutter til osten er gyllen og boblende.\n6. Server varme.",
    isKidFriendly: true,
  },
  {
    id: -66,
    name: "Kjøttkaker i brun saus med ertestuing",
    isFishMeal: false,
    isVegetarian: false,
    isVegan: false,
    cuisine: "Norsk",
    ...
    ingredients: [
      ...
      { name: "løk", quantity: 1, unit: "stk" },
      { name: "egg", quantity: 1, unit: "stk" },
      { name: "brødsmuler", quantity: 3, unit: "ss" },
      { name: "melk", quantity: 0.5, unit: "dl" },
      { name: "salt", quantity: 1, unit: "ts" },
      { name: "pepper", quantity: 0.5, unit: "ts" },
      { name: "smør", quantity: 2, unit: "ss" },
      { name: "hvetemel", quantity: 2, unit: "ss" },
      { name: "kjøttkraft", quantity: 4, unit: "dl" },
      { name: "erter", quantity: 300, unit: "g" },
      { name: "poteter", quantity: 6, unit: "stk" },
    ],
    instructions:
      "1. Bland kjøttdeig med finhakket løk, egg, brødsmuler, melk, salt og pepper. Form til flate kaker.\n2. Stek kjøttkakene i smør på middels varme i 4–5 minutter på hver side.\n3. Ta kjøttkakene ut. Smelt mer smør i pannen, rør inn mel og tilsett kjøttkraft litt etter litt til en brun saus.\n4. Legg kjøttkakene tilbake i sausen og la dem trekke i 10 minutter.\n5. Kok poteter og erter. Lag ertestuing med smør og litt melk.\n6. Server sammen.",
    isKidFriendly: true,
  },
  {
    id: -67,
    ...
    ingredients: [
      ...
      { name: "makaroni", quantity: 250, unit: "g" },
      { name: "smør", quantity: 3, unit: "ss" },
      { name: "hvetemel", quantity: 3, unit: "ss" },
      { name: "melk", quantity: 5, unit: "dl" },
      { name: "ost", quantity: 150, unit: "g" },
      { name: "salt", quantity: 0.5, unit: "ts" },
      { name: "pepper", quantity: 0.25, unit: "ts" },
    ...
    instructions:
      "1. Sett ovnen på 200°C. Kok makaronien halvferdig.\n2. Kok fisken forsiktig i lettsaltet vann i 5–7 minutter. Del i biter.\n3. Lag hvit saus: smelt smør, rør inn mel, tilsett melk litt etter litt.\n4. Smak til med salt og pepper. Rør inn halvparten av osten.\n5. Legg makaroni og fisk i en smurt ildfast form. Hell sausen over.\n6. Strø resten av osten på toppen.\n7. Gratiner i ovnen i 20–25 minutter til toppen er gyllen.",
    isKidFriendly: true,
  },
  {
    id: -68,
    name: "Vafler med syltetøy og rømme",
    isFishMeal: false,
    isVegetarian: true,
    isVegan: false,
    cuisine: "Norsk",
    prepTimeMinutes: 20,
    ingredients: [
      { name: "hvetemel", quantity: 3, unit: "dl" },
      { name: "sukker", quantity: 2, unit: "ss" },
      { name: "egg", quantity: 3, unit: "stk" },
      { name: "melk", quantity: 3, unit: "dl" },
      { name: "smør", quantity: 75, unit: "g" },
      { name: "bakepulver", quantity: 1, unit: "ts" },
      { name: "rømme", quantity: 2, unit: "dl" },
      { name: "jordbærsyltetøy", quantity: 3, unit: "ss" },
    ],
    instructions:
      "1. Smelt smøret og la det avkjøle litt.\n2. Visp sammen egg og sukker.\n3. Bland inn mel og bakepulver vekselvis med melk.\n4. Rør inn det smeltede smøret.\n5. Stek vaflene i et varmt vaffeljern til de er gylne.\n6. Server med rømme og syltetøy.",
    isKidFriendly: true,
  },
  {
    id: -69,
    name: "Pølsegryte med poteter og gulrot",
    isFishMeal: false,
    isVegetarian: false,
    isVegan: false,
    cuisine: "Norsk",
    prepTimeMinutes: 30,
    ingredients: [
      { name: "grillpølser", quantity: 6, unit: "stk" },
      { name: "poteter", quantity: 6, unit: "stk" },
      { name: "gulrot", quantity: 3, unit: "stk" },
      { name: "løk", quantity: 1, unit: "stk" },
      { name: "smør", quantity: 1, unit: "ss" },
    ...
    instructions:
      "1. Skrell og skjær poteter og gulrøtter i terninger. Finhakk løken.\n2. Skjær pølsene i tykke skiver.\n3. Brun pølsebitene i smør i en gryte.\n4. Tilsett løk og fres i 2 minutter.\n5. Legg i poteter og gulrøtter. Hell over kjøttkraft.\n6. Kok opp og la det småkoke i 20 minutter til grønnsakene er møre.\n7. Smak til med salt og pepper.",
    isKidFriendly: true,
  },
  {
    id: -70,
    ...
    prepTimeMinutes: 30,
    ingredients: [
      { name: "kyllingfilet", quantity: 300, unit: "g" },
      { name: "nudler", quantity: 200, unit: "g" },
      { name: "gulrot", quantity: 2, unit: "stk" },
      { name: "selleri", quantity: 2, unit: "stilker" },
      { name: "kyllingkraft", quantity: 8, unit: "dl" },
      { name: "salt", quantity: 0.5, unit: "ts" },
      { name: "pepper", quantity: 0.25, unit: "ts" },
    ],
    instructions:
      "1. Skjær kyllingfileten i små biter.\n2. Skrell og skjær gulrøttene i terninger. Skjær sellerien i biter.\n3. Kok opp kyllingkraften i en gryte.\n4. Tilsett gulrot og selleri, kok i 5 minutter.\n5. Legg i kyllingbitene og nudlene. Kok i 8–10 minutter.\n6. Smak til med salt og pepper. Server varm.",
    isKidFriendly: true,
  },
  {
    id: -71,
    ...
    prepTimeMinutes: 10,
    ingredients: [
      { name: "toastbrød", quantity: 8, unit: "skiver" },
      { name: "skinke", quantity: 8, unit: "skiver" },
      { name: "ost", quantity: 8, unit: "skiver" },
      { name: "smør", quantity: 2, unit: "ss" },
    ],
    instructions:
      "1. Smør brødskivene med smør.\n2. Legg skinke og ost mellom to skiver.\n3. Stek i toastjern eller i en stekepanne med lokk på middels varme.\n4. Stek i 2–3 minutter på hver side til brødet er sprøtt og osten smeltet.\n5. Skjær diagonalt og server med ketchup.",
    isKidFriendly: true,
  },
  {
    id: -72,
    name: "Risotto med kylling og mais",
    isFishMeal: false,
    isVegetarian: false,
    isVegan: false,
    cuisine: "Italiensk",
    ...
    ingredients: [
      ...
      { name: "løk", quantity: 1, unit: "stk" },
      { name: "kyllingkraft", quantity: 7, unit: "dl" },
      { name: "ost", quantity: 50, unit: "g" },
      { name: "smør", quantity: 2, unit: "ss" },
      { name: "salt", quantity: 0.5, unit: "ts" },
    ],
    instructions:
      "1. Skjær kyllingfileten i biter og stek i smør til den er gyllen. Ta den ut.\n2. Fres finhakket løk i pannen i 2 minutter.\n3. Tilsett risen og rør i 1 minutt.\n4. Tilsett kyllingkraft litt etter litt, rør ofte. La risen absorbere væsken mellom hvert tillegg.\n5. Etter ca. 18 minutter, rør inn kyllingen, maisen og revet ost.\n6. Smak til med salt og server.",
    isKidFriendly: true,
  },
  {
    id: -73,
    name: "Egg og bacon med toast",
    isFishMeal: false,
    isVegetarian: false,
    isVegan: false,
    cuisine: "Norsk",
    ...
    instructions:
      "1. Stek baconet sprøtt i en stekepanne. Legg til side på kjøkkenpapir.\n2. Stek eggene i smør og baconfettet på middels varme til ønsket konsistens.\n3. Rist brødskivene i brødrister eller på panne.\n4. Server egg og bacon med toast, salt og pepper.",
    isKidFriendly: true,
  },
  {
    id: -74,
    name: "Lasagne med kjøttsaus",
    isFishMeal: false,
    isVegetarian: false,
    isVegan: false,
    cuisine: "Italiensk",
    ...
    ingredients: [
      { name: "kjøttdeig", quantity: 500, unit: "g" },
      { name: "lasagneplater", quantity: 9, unit: "stk" },
      { name: "løk", quantity: 1, unit: "stk" },
      { name: "hvitløk", quantity: 2, unit: "fedd" },
    ...
    instructions:
      "1. Sett ovnen på 200°C.\n2. Brun kjøttdeigen med finhakket løk og hvitløk. Tilsett tomater og tomatpuré. Småkok i 15 minutter.\n3. Lag hvit saus: smelt smør, rør inn mel, tilsett melk litt etter litt under omrøring til den tykner.\n4. Legg lag i en smurt ildfast form: kjøttsaus, lasagneplater, hvit saus. Gjenta.\n5. Avslutt med hvit saus og rikelig revet ost.\n6. Stek i ovnen i 30–35 minutter til toppen er gyllen.",
    isKidFriendly: true,
  },
  {
    id: -75,
    name: "Pitabrød med kylling og tzatziki",
    isFishMeal: false,
    isVegetarian: false,
    isVegan: false,
    cuisine: "Midtøsten",
    ...
    ingredients: [
      { name: "kyllingfilet", quantity: 400, unit: "g" },
      { name: "pitabrød", quantity: 4, unit: "stk" },
      { name: "agurk", quantity: 0.5, unit: "stk" },
      { name: "tomat", quantity: 2, unit: "stk" },
      { name: "salat", quantity: 4, unit: "blader" },
      { name: "rømme", quantity: 2, unit: "dl" },
      { name: "hvitløk", quantity: 1, unit: "fedd" },
      { name: "olivenolje", quantity: 1, unit: "ss" },
      { name: "salt", quantity: 0.5, unit: "ts" },
    ...
    instructions:
      "1. Skjær kyllingfileten i strimler og stek i olivenolje med salt i 6–7 minutter.\n2. Lag tzatziki: riv agurken grovt, klem ut væsken. Bland med rømme og presset hvitløk.\n3. Varm pitabrødene i stekeovn på 180°C i 2–3 minutter.\n4. Skjær opp tomat og salat.\n5. Fyll pitabrødene med kylling, salat, tomat og tzatziki.",
    isKidFriendly: true,
  },
];
